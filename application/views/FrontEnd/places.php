...
<dir class="col-lg-12">
	<center>
		<h3 style="color: #563d7c;">Learning For you</h3>
	</center>
</dir>
<div class="container">
	<div class="row">
		...
		?>
				<div class="col-lg-8">
					<span class="card" style="margin-bottom: 2%">
						...
						<center>
							<h5><?php echo $p->place_name ?></h5>
						</center>
						<h3 style="color:black"><?php echo $p->place_name ?></h3>
						<p style="color:black"><?php echo $p->place_description ?></p>

						<h5>Content with Guides</h5>
						<a href="<?php echo $p->area ?>"><?php echo $p->area ?></a>

						<p><a href="<?php echo base_url('home/fetchGuideByPlaceName/' . $p->id) ?>" class="btn btn-primary" style="margin-bottom: 15px">Click to learn</a></p>
					</span>
				...
				<div class="col-lg-4">
					...
					?>
						<br>
						<h3 style="color: #563d7c;margin-top: 8%">Other Language </h3>
