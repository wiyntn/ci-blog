...
<dir class="col-lg-12" ><center><h3 style="color: #563d7c;">Learning For you</h3></center></dir>
<div class="container">
	<div class="row">
		<?php 
		$divCount=0;
		...
		<div class="col-lg-8">
			...
			<p><a href="<?php echo base_url('home/fetchGuideByPlaceName/'.$p->area) ?>" class="btn btn-primary" style="margin-bottom: 15px">Click to learn</a></p>
			</span>
