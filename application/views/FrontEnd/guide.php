    ...
    ?>
        ...
        <div class="col-lg-4" style="margin-top: -40px;">
          <div class="card">
            ...
            <div class="card-body">
              <center>
                <h5 class="card-title" style="color:green;font-weight: bold"><?php echo $p->name ?></h5>
              </center>
            ...
            <div class="card-body">
              <a href="<?php
                        ...
                        ?>" class="btn btn-primary">Content to Guide</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      ...
      <div class="col-lg-12">
        <span class="card" style="margin-top: 15%;margin-bottom: 15%">
          <div class="alert danger alert-dismissible" role="alert">
            ...
            <h1 style="color:red">
              <center>Sorry!No Guide Available There!!</center>
            </h1>
