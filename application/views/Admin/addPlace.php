<div class="container">
  <div class="row">
    <div style="margin-top:30px;margin-left: 150px;">
      ...
      <?php echo form_open_multipart('Admin/languageAdd', '', '') ?>
      <h2>Add Language</h2>
      <div>
      ...
      <div class="form-group">
        <label for="sel1">Language Type</label>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control rounded-0" id="exampleFormControlTextarea1" rows="10" name="area"></textarea>
      </div>

      <div class="form-group">
        <?php echo form_submit('Add Place', 'Add Language', 'class="btn btn-primary"'); ?>
      </div>
