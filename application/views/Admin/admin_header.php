...
<body>
  <div class="container-scroller" style="margin-right: -75px;">
    <!-- partial:partials/_navbar.html -->
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand " href="#">Htun IT Blog</a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#type" aria-expanded="false" aria-controls="type">
              ...
              <span class="menu-title">Language Type</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="type">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/addLanguageType') ?>">Add Language Type</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/viewLanguageType') ?>">View Language Type</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#lan" aria-expanded="false" aria-controls="lan">
            ...
            <div class="collapse" id="lan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/addLanguage') ?>">Add Language</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/viewLanguage') ?>">View Language</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="blog">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/addBlog') ?>">Add Blog</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('Admin/viewBlog') ?>">View Blog</a></li>
