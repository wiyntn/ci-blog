<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><button class="btn btn-success"><a style="color:#ffff" href="<?php echo base_url('admin/editLanguage/'.$p->id) ?>">Edit</a></button></td> 
      <td><button class="btn btn-danger"><a style="color:#ffff" href="<?php echo base_url('admin/deleteLanguage/'.$p->id) ?>">Delete</a></button></td>
