...
class Guide extends CI_Controller {
	...
	//load Model
	$this->load->model('ModAdmin','modAdmin');
    $this->load->model('ModUser', 'modUser');
	}

	public function index()
	{
		
		$this->load->view('Guide/login');
		
		
	}
	public function deshboard(){
		$this->load->view('Guide/header');
		$this->load->view('Guide/guide_header');
		$this->load->view('Guide/deshboard');
		$this->load->view('Guide/guide_footer');
		$this->load->view('Guide/footer');
	}
    ...
    public function login()
	{
        ...
        //     $this->load->view('Guide/header');
        //     $this->load->view('Guide/guide_header');
        //     $this->load->view('Guide/viewUser',$data);
        //     $this->load->view('Guide/guide_footer');
        //     $this->load->view('Guide/footer');
        // }
        ...
        public function viewPlace(){
            ...
            $this->load->view('Guide/header');
            $this->load->view('Guide/guide_header');
            $this->load->view('Guide/viewPlace',$data);
            $this->load->view('Guide/guide_footer');
            $this->load->view('Guide/footer');
        }
